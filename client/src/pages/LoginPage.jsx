      ...
      <p className="text-sm mb-6 text-gray-600">
        {mode === 'login' ? (
          <>
            ...
            <Link to="/login" type="button" className="text-blue-600 hover:underline" onClick={() => setMode('signup')}>
              Create one
            </Link>
          </>
        ) : (
          <>
            ...
            <Link to="/login" type="button" className="text-blue-600 hover:underline" onClick={() => setMode('login')}>
              Sign in
            </Link>
          </>
        )}
