...
export default function NotFoundPage() {
  ...
  return (
    <div className="max-w-xl mx-auto p-10 bg-white dark:bg-gray-800 rounded-lg shadow">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-gray-100">404</h1>
